...
const enemies_per_type = {
	EnemyType.NORMAL: preload("res://scenes/spaceship_enemy_ram_base.tscn"),
	EnemyType.SCOUT: preload("res://scenes/spaceship_enemy_ram_base.tscn"),
	EnemyType.CRUISER: preload("res://scenes/spaceship_enemy_ram_base.tscn"),
	EnemyType.HUNTER: preload("res://scenes/spaceship_enemy_ram_base.tscn"),
	EnemyType.MONOLITH: preload("res://scenes/spaceship_enemy_ram_base.tscn"),
